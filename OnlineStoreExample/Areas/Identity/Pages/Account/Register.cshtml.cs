...
namespace OnlineStoreExample.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private readonly OnlineStoreLibrary.DataAccess.IEmailSender _emailSender;
        ...
        public RegisterModel(
            ...
            OnlineStoreLibrary.DataAccess.IEmailSender emailSender)
        {
            ...
            if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Подтвердите свой Email",
                        $"Пожалуйста, подтвердите свою почту, для этого <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>нажмите сюда</a>.");
        ...
        private UserModel CreateUser()
        {
            try
            {
                var user = Activator.CreateInstance<UserModel>();
